...
import Card from "./components/card";
 ...
 const jobOpenings = [
    ...
    {
      brandLogo: "https://th.bing.com/th/id/OIP.L7WJ6Ex-0HPzE1Tncu9ITgHaHa?w=177&h=150&c=6&o=7&cb=ucfimg2&dpr=1.5&pid=1.7&rm=3&ucfimg=1",
      companyName: "Amazon",
  ...
  return (
    <div className="parent">
      {jobOpenings.map(function(ele,idx){
        return <div key={idx}>
          <Card companyName={ele.companyName} brandLogo={ele.brandLogo} datePosted={ele.datePosted} post={ele.post} tag1={ele.tag1} tag2={ele.tag2} pay={ele.pay} location={ele.location}/>
          </div>
      })}
    </div>
